    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-24">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-mono font-black uppercase tracking-tight mb-8 text-foreground leading-tight">
            How It Works
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-10 mb-24">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              {/* Step Number */}
              <div className="absolute -top-4 -left-4 w-10 h-10 bg-primary text-primary-foreground rounded-full flex items-center justify-center text-sm font-mono font-bold">
                {index + 1}
              </div>
              ...
              <div className="bg-card border border-border rounded-lg p-8 lg:p-10 h-full hover:shadow-lg transition-all duration-300 hover:border-foreground/50">
                ...
                <h3 className="text-xl font-mono font-black mb-4 text-foreground tracking-tight leading-tight">
                  {step.title}
                </h3>
        ...
        <div className="bg-card border border-border rounded-lg p-10 lg:p-12 mb-16">
          <h3 className="text-2xl md:text-3xl font-mono font-black mb-12 text-center text-foreground tracking-tight leading-tight">
          ...
          <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
            {features.map((feature, index) => (
              <div key={index} className="text-center">
                ...
                <h4 className="text-lg font-mono font-black mb-4 text-foreground tracking-tight">
                  {feature.title}
                </h4>
                <p className="font-mono text-muted-foreground leading-relaxed">
                  {feature.description}
