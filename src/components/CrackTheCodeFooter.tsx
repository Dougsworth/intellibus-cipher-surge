  ...
  <footer className="mt-32 border-t border-border bg-background">
    <div className="max-w-7xl mx-auto py-24 px-6">
      ...
      <div className="text-center mb-24">
        <h2 className="text-4xl md:text-5xl lg:text-6xl font-mono font-black uppercase tracking-tight leading-tight text-foreground flex items-center justify-center gap-4 mb-8">
      ...
      <div className="bg-card border border-border rounded-lg p-10 lg:p-12 mb-16">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1 min-w-0">
            <h2 className="text-2xl md:text-3xl font-mono font-black mb-6 text-foreground tracking-tight leading-tight">
              About Crack the Code
            </h2>
            <p className="text-lg font-mono text-muted-foreground mb-4 leading-relaxed">
      ...
      <div className="bg-card border border-border rounded-lg p-10 lg:p-12 mb-16">
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            <ul className="font-mono text-muted-foreground space-y-3 leading-relaxed">
        ...
        <div className="flex items-start space-x-6">
          ...
          <div className="flex-1 min-w-0">
            ...
            >
              <Button
                variant="outline"
                className="border-2 border-foreground text-foreground hover:bg-foreground hover:text-background font-mono font-black transition-all duration-300"
              >
                WATCH INTRO VIDEO
              </Button>
            </a>
